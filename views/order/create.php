                            ...
                            <div class="card-body">
                                <form class="form" method="post" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="donationinput1" class="sr-only">Tên người nhận</label>
                                            <input type="text" name="receiver" id="donationinput1" class="form-control" placeholder="Tên người nhận" >
                                        </div>
                                        <div class="form-group">
                                        <label for="product" class="pl-2 h5">Chọn sản phẩm</label>
                                        <select id="product" name="product[]" multiple class="form-control" >
                                        
                                            <?php foreach($data['products'] AS $key => $value) :?>
                                                <option value="<?php echo $value['TenSanPham'];?>">
                                        ...
                                        <div class="form-group">
                                            <label for="donationinput2" class="sr-only">Địa chỉ giao hàng</label>
                                            <input type="text" name="shipaddress" id="donationinput2" class="form-control" placeholder="Địa chỉ giao hàng" >
                                        </div>
